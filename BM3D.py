...
if __name__ == '__main__':
    ...
    cv2.imwrite(basic_path, basic_img_uint)
    step1_time = time.time()
    print(f'Basic estimate saved → {basic_path}  ({step1_time - start_time:.1f}s)\n')
    ...
    print(f'Final estimate saved  → {final_path}  ({step2_time - step1_time:.1f}s)\n')
