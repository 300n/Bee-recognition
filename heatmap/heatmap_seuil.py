...
def generate_conditional_heatmap(image_path, r, threshold_val, output_folder):
    ...
    result[mask_bees, 2] = heatmap_values[
        mask_bees
    ]  # Canal Rouge (intensité liée à la chaleur)
...
THRESHOLD_VAL = 70
INPUT = (
    "/Users/valentindaveau/2IA_S8/Mission_R&D/Bee-recognition/images2/M01C02_031942.png"
)
OUTPUT = "/Users/valentindaveau/2IA_S8/Mission_R&D/Bee-recognition/Output/heatmap"
